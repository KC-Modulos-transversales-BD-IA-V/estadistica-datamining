...
p <- predict(model, data.frame(Birthweight=peso), type="response")
...
p1 <- predict(model, data.frame(Birthweight=peso1), type='response')
p2 <- 1/(1+exp(-(model$coefficients[1]+peso2*model$coefficients[2])))
p2 <- predict(model, data.frame(Birthweight=peso2), type='response')
