...
curl_download('https://s3-eu-west-1.amazonaws.com/pfigshare-u-files/5976015/lfwfunneled.tgz',out_file,quiet=FALSE)
```
...
```{r}
img <- get_pic('Tony_Blair',id=3, bw=T, root_path=ext_dir)
